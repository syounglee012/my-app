        ...
        <div className={active ? "active" : "transition"} ref={activeRef}>
          ...
          <figure className="img_wrapper">
              ...
              <div className="square">
                ...
                <div className="bottomWrap">
                  ...
                  <ul>
                    ...
                    <li>
                      Applying the dynamic and federated search used by more
                      than 5000 employees and other consumers, significantly
                      reduced the number of required searches and costs
                      allocated with each query.
                    </li>
                    <li>
                      ...
                      more detailed view associated with each different
                      location.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      friendly UI and enable responsive design to support the
                      web app on all different platforms.
                    </li>
                  </ul>
                </div>
            ...
            <ul className="social_media">
              ...
              <li>
                <a
                  onClick={() => window.open("https://github.com/syounglee012")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
