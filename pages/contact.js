  ...
  return (
    <Wrap>
      <div class="container d-flex justify-content-center align-items-center">
        ...
        <form>
          <h1 class="title text-center mb-4">Contact Me</h1>
...
const Wrap = styled.div`
  ...
  height: 100vh;
  width: 100%;
  background: url("images/whiteBG.jpeg") no-repeat center center/cover;
  svg {
    height: 29rem;
    margin: 2rem;
  ...
  @media screen and (max-width: 500px) {
    background: url("images/whiteBG.jpeg") contain;
